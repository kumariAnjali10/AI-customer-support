...
//         </button>
//       </div>
//       <nav className="bg-gray-300 rounded-full w-3/4 mt-10 p-4  border-2 border-blue-500  ">
...
//         <p className="text-gray-500 text-xl">Educational Support Chatbot</p>
//       </div>
//     </div>
//   );
// }
